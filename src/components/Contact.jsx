...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
            .send(
                'service_63xw4ab',          // Your service ID
                'template_9bybmgk',         // Your template ID
                {
                    from_name: username,
                    to_name: "Parth Patel",
                    reply_to: user_email,
                    to_email: "pmp3820@gmail.com", // Your destination email
                    message: user_message,
                },
                'Ef9O09bOaw0GIKcB0'          // Your public key
            )
            .then(
                () => {
                    setLoading(false);
        ...
        <div className='relative z-0 bg-black w-screen h-screen mt-12'>   
            <div className='text-white contact overflow-x-hidden pt-12 mt-8 ' id='contact'>
                <div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
                    ...
                    <h2 className='text-5xl font-extrabold mt-2 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400'>Contact.</h2>
                    <form
                        ref={formRef}
